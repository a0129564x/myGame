...
require(
   ["jsaSound/jsaModels/KnockOnWood", "../jslibs/raphael.lonce"],  
    function (knockFactory) {
            
        var knock = knockFactory();

        knock.setParam("play", 1);    //or// knock.setParamNorm("play", 0.500);
        knock.setParam("Gain", 0.8);    //or// knock.setParamNorm("Gain", 0.800);

        var soundplay = function(){

            setTimeout(function(){

                knock.setParam("play", 1);
                knock.setParam("Release Time", 0.1);
                console.log("knock sound!"); 
